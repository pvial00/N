...
defaultos = 0
ostypes = {'debian':0, 'freebsd':1, 'solaris':2, 'openbsd':3, 'netbsd':4, 'minix':5,'windows-server':6,'macos':7, 'krypto':8}
xmltemplates = {0:'/build/debian-template.xml', 1:'/build/freebsd.xml', 2:'/build/solaris.xml', 3:'/build/openbsd.xml', 4:'/build/netbsd.xml', 5:'/build/minix.xml',6:'/build/windows.xml',7:'/build/macos.xml', 8:'/build/debian-template.xml'}
vmimages = {0:'/build/debian.img', 1:'/build/freebsd.img', 2:'/build/solaris.img', 3:'/build/openbsd.img', 4:'/build/netbsd.img',5:'/build/minix.img',6:'/build/windows.img',7:'/build/macos.img', 8:'/build/debian-salt.img'}
rootparts = {0:"p1", 1:"/dev/loop0p1", 2:"/dev/loop0p1", 3:"/dev/loop0p1", 4:"/dev/loop0p1", 5:"/dev/loop0p1",6:"changeme",7:"changeme", 8:"p1"}
storagetypes = {0:10000, 1:10000, 2:20000, 3:10000, 4:10000, 5:10000, 6:20000, 7:30000, 8:10000}
